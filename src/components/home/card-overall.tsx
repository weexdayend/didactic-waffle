    ...
    <div className='grid w-full h-full bg-zinc-900/90 dark:bg-white px-6 py-6 rounded-3xl'>
      <div className='flex flex-col h-full w-full justify-center gap-2'>
        ...
        <div className='grid grid-cols-3 gap-2 my-4'>
          <div className='flex flex-col w-full h-full bg-zinc-900/30 px-2 py-4 rounded-xl'>
            <h1 className='text-sm text-white dark:text-zinc-900'>4.000</h1>
            <h1 className='text-sm text-white dark:text-zinc-900'>UREA</h1>
          </div>
          <div className='w-full h-full bg-zinc-900/30 px-2 py-4 rounded-xl'>
            <h1 className='text-sm text-white dark:text-zinc-900'>4.000</h1>
            <h1 className='text-sm text-white dark:text-zinc-900'>ORGANIK</h1>
          </div>
          <div className='w-full h-full bg-zinc-900/30 px-2 py-4 rounded-xl'>
            <h1 className='text-sm text-white dark:text-zinc-900'>2.000</h1>
            <h1 className='text-sm text-white dark:text-zinc-900'>NPK</h1>
          </div>
        </div>
        <h6 className='text-sm text-white dark:text-zinc-900 mt-4'>Satuan dalam (Ton).</h6>
      </div>
    </div>
  )
}
