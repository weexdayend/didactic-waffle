...
const CardOverall = () => {
  ...
  return (
    <div className='grid w-full h-full md:col-span-2 lg:col-span-2 xl:col-span-2 bg-zinc-900/90 dark:bg-white px-6 py-6 rounded-3xl'>
      <div className='flex flex-col h-full w-full justify-between gap-2'>
        ...
        <div className='grid grid-cols-3 gap-4 items-center justify-between my-4'>
          ...
          <div className='w-full h-full border-b pb-2'>
            ...
            <h1 className='text-sm text-white dark:text-zinc-900'>KHUSUS</h1>
          </div>
        </div>
