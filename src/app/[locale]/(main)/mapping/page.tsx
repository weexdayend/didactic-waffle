...
const Page = () => {
  ...
  return (
    <div className='flex flex-col items-center pb-20 pt-20'>
      <div className='absolute w-full px-6 pt-4 z-[45] top-20'>
      {myLocation === null ? (
        <></>
      ) : (
        <ComboboxDemo handle={handleSelected} clearInformation={clearInformation} />
      )}
      </div>
      <div className='z-[40]'>
        <Map myLocation={myLocation} selectedPosition={selected} resetLocation={resetLocation} />
      </div>
      {myLocation === null ? (
        <>
        </>
